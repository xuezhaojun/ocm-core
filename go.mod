module open-cluster-management.io/ocm-core
...
require (
	...
	open-cluster-management.io/registration v0.0.0-00010101000000-000000000000
	open-cluster-management.io/work v0.0.0-00010101000000-000000000000
)
...
require (
	...
	open-cluster-management.io/api v0.10.1-0.20230310025041-ca0770573954 // indirect
